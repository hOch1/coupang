...
//
// 	@Mock
// 	private ProductSubOptionRepository productOptionRepository;
//
// 	@Mock
// 	private StoreRepository storeRepository;
//
// 	@Mock
// 	private SubOptionValueRepository optionValueRepository;
//
// 	@Mock
...
// 		SubOptionValue mockSubOptionValue = mock(SubOptionValue.class);
//
...
// 		when(optionValueRepository.findById(anyLong())).thenReturn(Optional.of(mockSubOptionValue));
//
...
// 		verify(productOptionRepository, times(6)).save(any(ProductSubOption.class));
// 	}
//
// 	@Test
...
// 		verify(productRepository).save(any(Product.class));
// 		verify(productDetailRepository, times(1)).save(any(ProductDetail.class));
// 		verify(productOptionRepository, never()).save(any(ProductSubOption.class));
// 	}
//
// 	@Test
