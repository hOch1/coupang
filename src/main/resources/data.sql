...
# INSERT INTO variant_option (category_id, option_name, description) VALUES (@MEN_ID, 'AGE', '남성 나이대');
# SET @MEN_AGE_ID = LAST_INSERT_ID();
# INSERT INTO variant_option (category_id, option_name, description) VALUES (@WOMEN_ID, 'AGE', '여성 나이대');
# SET @WOMEN_AGE_ID = LAST_INSERT_ID();

-- 홈 옵션
INSERT INTO variant_option (category_id, option_name, description) VALUES (@HOME_ID, 'COLOR', '색상');
...
-- 음식
INSERT INTO category_option_value (category_option_id, value, description) VALUES (@FOOD_DOMESTIC_yn, 'Y', '국내산');
INSERT INTO category_option_value (category_option_id, value, description) VALUES (@FOOD_DOMESTIC_yn, 'N', '수입산');

-- 홈
INSERT INTO category_option_value (category_option_id, value, description) VALUES (@HOME_MATERIAL_ID, 'WOOD', '원목');
INSERT INTO category_option_value (category_option_id, value, description) VALUES (@HOME_MATERIAL_ID, 'METAL', '철제');
INSERT INTO category_option_value (category_option_id, value, description) VALUES (@HOME_MATERIAL_ID, 'PLASTIC', '플라스틱');
...
# INSERT INTO variant_option_value (variant_option_id, value, description) VALUES (@MEN_AGE_ID, '10', '10대');
# INSERT INTO variant_option_value (variant_option_id, value, description) VALUES (@MEN_AGE_ID, '20', '20대');
# INSERT INTO variant_option_value (variant_option_id, value, description) VALUES (@MEN_AGE_ID, '30', '30대');
#
# INSERT INTO variant_option_value (variant_option_id, value, description) VALUES (@WOMEN_AGE_ID, '10', '10대');
# INSERT INTO variant_option_value (variant_option_id, value, description) VALUES (@WOMEN_AGE_ID, '20', '20대');
# INSERT INTO variant_option_value (variant_option_id, value, description) VALUES (@WOMEN_AGE_ID, '30', '30대');

-- 홈
INSERT INTO variant_option_value (variant_option_id, value, description) VALUES (@HOME_COLOR_ID, 'WHITE', '화이트');
INSERT INTO variant_option_value (variant_option_id, value, description) VALUES (@HOME_COLOR_ID, 'BLACK', '블랙');
INSERT INTO variant_option_value (variant_option_id, value, description) VALUES (@HOME_COLOR_ID, 'ETC', '기타');